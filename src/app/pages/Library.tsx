              ...
              <div className="relative h-[200px] md:h-[500px] overflow-hidden z-10 ">
                ...
                {selectedGame.titleImage && (
                  <img
                    ...
                    style={{
                      maxHeight: `${260 * (selectedGame.titleSizeMultiplier || 1)}px`,
                      maxWidth: `${0.5 * 100 * (selectedGame.titleSizeMultiplier || 1)}%`,
                    }}
                  />
                )}
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-8">
                  ...
                  <div className="lg:col-span-2 space-y-8">
                    ...
                    <div className="p-6 rounded-lg shadow" style={{ backgroundColor: 'var(--theme-card-bg)', backdropFilter: 'var(--theme-backdrop-blur)', WebkitBackdropFilter: 'var(--theme-backdrop-blur)' }}>
                      <h2 className="text-2xl font-bold mb-4" style={{ color: 'var(--theme-text-primary)' }}>About This Game</h2>
                      <p className="leading-relaxed whitespace-pre-wrap" style={{ color: 'var(--theme-text-secondary)' }}>{selectedGame.description}</p>
                    </div>
                    {/* Media Carousel */}
